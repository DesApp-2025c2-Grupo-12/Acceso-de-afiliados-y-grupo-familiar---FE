...
export default function Autorizaciones() {
    ...
    // Ejemplo de integrantes de cuenta
    const integrantesCuenta = ["Franco Cantero", "Bianca Margarita"];

    // Filtrar autorizaciones por búsqueda (paciente o médico)
        ...
        <div className="container">
            ...
            <div className="row">
                {autorizacionesFiltradas.map((auto) => (
                    <CardAutorizacion key={auto.id} autorizacion={auto} />
                ))}
            </div>
